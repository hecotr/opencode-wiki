...
title: network
slug: network
url: https://opencode.ai/docs/zh-cn/network/
source: opencode.ai
lang: zh-CN
---
...
Terminal window
```
# HTTPS proxy (recommended)export HTTPS_PROXY=https://proxy.example.com:8080 # HTTP proxy (if HTTPS not available)export HTTP_PROXY=http://proxy.example.com:8080 # Bypass proxy for local server (required)export NO_PROXY=localhost,127.0.0.1
```
